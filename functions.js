...
function channelHasVideo(videoTitle, channel) {
  channel.videos.some((video) => video.videoTitle === videoTitle);
}
...
function getChannelByName(channelName, channels) {
  return channel.find((channel) => channels.name === channelName);
}
...
//   return channel.find((channel) => channels.videoTitle);
// }
